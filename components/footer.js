      ...
      return (
        <footer className="footer mt-5 has-top-border">
          <div className="columns is-size-7">
            ...
            <a className='pl-2 icon' href='https://linkedin.com/in/ashwan1' target='_blank'><img src="/static/images/linkedin.svg" width="25" height="25" /></a>
            <a className='pl-2 icon' href='https://twitter.com/4shw4n1' target='_blank'><img src="/static/images/twitter.svg" width="25" height="25" /></a>
            </div>
          </div>
        </footer>
      );
